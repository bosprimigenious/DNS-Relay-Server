...

{
    ...
    echo ""
    echo "========== basic queries =========="
    python3 platform/common/python/dns_query.py "$DNS_RELAY_BIND" "$DNS_RELAY_PORT" bupt 008.cn baidu.com
    echo ""
    echo "========== cache probe =========="
    python3 platform/common/python/dns_query.py "$DNS_RELAY_BIND" "$DNS_RELAY_PORT" baidu.com baidu.com
    echo ""
    echo "========== qtype / qclass =========="
    python3 platform/common/python/dns_query.py "$DNS_RELAY_BIND" "$DNS_RELAY_PORT" bupt:MX
    echo ""
    echo "========== nslookup =========="
